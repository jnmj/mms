...
<div class="sidebar-nav" style="display: inline-block; width: 200px">
				<ul class="nav nav-list">
					<li>
						<a href="#user-menu" class="nav-header" data-toggle="collapse" ><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;个人中心</a> 
				...
				<ul class="nav nav-list">
					<li>
						<a href="#manage-menu" class="nav-header" data-toggle="collapse"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;人事管理</a>
				...
				<ul class="nav nav-list">
					<li>
						<a href="#meeting-menu" class="nav-header" data-toggle="collapse"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;会议预定</a>  
